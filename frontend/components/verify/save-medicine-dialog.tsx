...
const saveMedicineSchema = z.object({
  currentQuantity: z.coerce.number().min(0, "Quantity cannot be negative").optional(),
  totalQuantity: z.coerce.number().min(1, "Total must be at least 1").optional(),
...
const SECTION_LABEL_CLASSES = "text-xs font-bold text-muted-foreground/80 flex items-center gap-2 mb-3 px-1";
                          ...
                          <FormControl>
                            <div className="space-y-4">
                              <div className="flex items-center justify-between">
                                <FormLabel className="text-xs font-semibold text-muted-foreground/70 ml-1">Linked Prescriptions</FormLabel>
                                <Button
                                  type="button"
                                  variant="outline"
                                  size="sm"
                              ...
                              {field.value.length > 0 && (
                                <div className="p-3 rounded-2xl bg-primary/5 border border-primary/10">
                                  <p className="text-[10px] font-bold text-primary mb-2 px-1">Selected attachments</p>
                                  <div className="flex flex-wrap gap-2">
                                    {field.value.map((id: string) => (
                                      <div key={id} className="px-3 py-1 bg-background border border-primary/20 rounded-full text-[10px] font-bold text-primary flex items-center gap-1.5">
