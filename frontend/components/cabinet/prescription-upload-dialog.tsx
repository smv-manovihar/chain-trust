...
export function PrescriptionUploadDialog({ 
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      // Ensure label includes extension from file if missing
      ...
      toast.success("Prescription uploaded", {
        description: `"${finalLabel}" has been added to your pool.`
      });
  ...
  return (
    <ResponsiveDialog open={open} onOpenChange={onOpenChange}>
      <ResponsiveDialogContent className="w-full sm:max-w-md bg-background/95 backdrop-blur-md border-zinc-800 p-0 overflow-hidden">
        <ResponsiveDialogBody className="px-6 py-8 space-y-6">
